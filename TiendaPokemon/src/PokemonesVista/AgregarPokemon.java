...
public class AgregarPokemon extends javax.swing.JFrame {
    ...
    *atributos
    *-----------------------------*/
    private String codPok;
    private String nomPok;
    private String tipPok;
    private String sexPok;
    private String varPok;
    private String estPok;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(selec==0)
        {
            ...
            if(seleccion==0)
              {
                ...
                codPok=TexFieCodPok.getText();
                nomPok=TexFieNomPok.getText();
                tipPok="";
            ...
            estPok=spiEst.getValue().toString();
            String[] pokemon={codPok,nomPok,tipPok,sexPok,varPok,estPok};
            System.out.print("codigo "+codPok);
            ...
            else
        {
            try{
                ...
                escribir.write(TexFieCodPok.getText());
                escribir.write(", ");
                escribir.write(TexFieNomPok.getText());
                escribir.write(", ");
                escribir.write(tipPok);
                escribir.write(", ");
                escribir.write(sexPok);
                escribir.write(", ");
                escribir.write(varPok);
                escribir.write(", ");
                escribir.write(estPok);
                escribir.write("\n");
                escribir.close();
